import { NotificationListResponseData } from '@/src/app/_api/axios/notification'
    ...
    <>
      ...
      {items && page_size > 0 && (
        <div className='p-compact'>
          <span className='text-body-sm font-semi-bold text-primary-418-80'>Most Recent</span>
